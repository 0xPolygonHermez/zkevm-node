...
#### <a name="Sequencer_Finalizer_SequentialReprocessFullBatch"></a>10.6.11. `Sequencer.Finalizer.SequentialReprocessFullBatch`
...
### <a name="Sequencer_Http"></a>10.9. `[Sequencer.Http]`
...
#### <a name="Sequencer_Http_Host"></a>10.9.1. `Sequencer.Http.Host`
...
#### <a name="Sequencer_Http_Port"></a>10.9.2. `Sequencer.Http.Port`
...
#### <a name="Sequencer_Http_MaxRequestsPerIPAndSecond"></a>10.9.3. `Sequencer.Http.MaxRequestsPerIPAndSecond`
...
#### <a name="Sequencer_Http_ReadTimeout"></a>10.9.4. `Sequencer.Http.ReadTimeout`
...
#### <a name="Sequencer_Http_WriteTimeout"></a>10.9.5. `Sequencer.Http.WriteTimeout`

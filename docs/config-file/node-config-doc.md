...
| - [MarginBreakEven](#Pool_EffectiveGasPrice_MarginBreakEven )   | No      | integer | No         | -          | MarginBreakEven is the max allowed margin percentage between the breakevenGasPrice and gasPriceSigned of a tx |
| - [FinalDeviation](#Pool_EffectiveGasPrice_FinalDeviation )     | No      | integer | No         | -          | FinalDeviation is the max allowed deviation percentage BreakEvenGasPrice on re-calculation                    |
...
#### <a name="Pool_EffectiveGasPrice_MarginBreakEven"></a>7.11.6. `Pool.EffectiveGasPrice.MarginBreakEven`

**Type:** : `integer`

**Default:** `10`

**Description:** MarginBreakEven is the max allowed margin percentage between the breakevenGasPrice and gasPriceSigned of a tx
...
#### <a name="Pool_EffectiveGasPrice_FinalDeviation"></a>7.11.7. `Pool.EffectiveGasPrice.FinalDeviation`

**Type:** : `integer`

**Default:** `10`

**Description:** FinalDeviation is the max allowed deviation percentage BreakEvenGasPrice on re-calculation

...
func (s *State) ResetDB(ctx context.Context, block *etherman.Block, tx pgx.Tx) error {
...
func (s *State) AddBlock(ctx context.Context, block *etherman.Block, tx pgx.Tx) error {

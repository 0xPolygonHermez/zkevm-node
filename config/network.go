...
type networkConfigFromJSON struct {
	...
	GlobalExitRootManagerAddr     string            `json:"globalExitRootManagerAddr"`
	GlobalExitRootManagerPosition uint64            `json:"globalExitRootManagerPosition"`
...
var (
	mainnetConfig = NetworkConfig{
		...
		GlobalExitRootManagerPosition: 2,
		L1ChainID:                     1, //Mainnet
...
func loadCustomNetworkConfig(ctx *cli.Context) (NetworkConfig, error) {
	...
	cfg.GlobalExitRootManagerPosition = cfgJSON.GlobalExitRootManagerPosition

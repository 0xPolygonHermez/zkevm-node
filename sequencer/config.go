...
type FinalizerCfg struct {
	...
	// SendingToL1DeadlineTimeout is the time the finalizer waits after receiving closing signal to sends a batch to L1
	SendingToL1DeadlineTimeout types.Duration `mapstructure:"SendingToL1DeadlineTimeout"`

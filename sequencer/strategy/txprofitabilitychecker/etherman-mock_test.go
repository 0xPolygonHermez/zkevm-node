...
// txprofitabilitycheckerEtherman is an autogenerated mock type for the txprofitabilitycheckerEtherman type
type txprofitabilitycheckerEtherman struct {
	mock.Mock
}

// EstimateSendBatchCost provides a mock function with given fields: ctx, txs, maticAmount
func (_m *txprofitabilitycheckerEtherman) EstimateSendBatchCost(ctx context.Context, txs []*types.Transaction, maticAmount *big.Int) (*big.Int, error) {
...
func (_m *txprofitabilitycheckerEtherman) GetCurrentSequencerCollateral() (*big.Int, error) {
	ret := _m.Called()

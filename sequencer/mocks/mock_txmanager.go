...
func (_m *TxmanagerMock) Add(ctx context.Context, owner string, id string, from common.Address, to *common.Address, value *big.Int, data []byte, dbTx pgx.Tx) error {
...
func (_m *TxmanagerMock) Result(ctx context.Context, owner string, id string, dbTx pgx.Tx) (ethtxmanager.MonitoredTxResult, error) {
...
func (_m *TxmanagerMock) ResultsByStatus(ctx context.Context, owner string, statuses []ethtxmanager.MonitoredTxStatus, dbTx pgx.Tx) ([]ethtxmanager.MonitoredTxResult, error) {
...
func (_m *TxmanagerMock) SetStatusDone(ctx context.Context, owner string, id string, dbTx pgx.Tx) error {
	ret := _m.Called(ctx, owner, id, dbTx)

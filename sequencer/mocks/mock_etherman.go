...
func (_m *EthermanMock) EstimateGasSequenceBatches(sequences []state.Sequence) (*types.Transaction, error) {
	ret := _m.Called(sequences)

	var r0 *types.Transaction
	if rf, ok := ret.Get(0).(func([]state.Sequence) *types.Transaction); ok {
		r0 = rf(sequences)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]state.Sequence) error); ok {
		r1 = rf(sequences)
	} else {
		r1 = ret.Error(1)
	}

...
func (_m *StateMock) CountReorgs(ctx *context.RequestContext, dbTx pgx.Tx) (uint64, error) {
...
func (_m *StateMock) FlushMerkleTree(ctx *context.RequestContext) error {
	ret := _m.Called(ctx)
...
func (_m *StateMock) GetBalanceByStateRoot(ctx *context.RequestContext, address common.Address, root common.Hash) (*big.Int, error) {
...
func (_m *StateMock) GetForcedBatch(ctx *context.RequestContext, forcedBatchNumber uint64, dbTx pgx.Tx) (*state.ForcedBatch, error) {
	ret := _m.Called(ctx, forcedBatchNumber, dbTx)

	var r0 *state.ForcedBatch
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint64, pgx.Tx) (*state.ForcedBatch, error)); ok {
		return rf(ctx, forcedBatchNumber, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint64, pgx.Tx) *state.ForcedBatch); ok {
...
func (_m *StateMock) GetForcedBatchesSince(ctx *context.RequestContext, forcedBatchNumber uint64, maxBlockNumber uint64, dbTx pgx.Tx) ([]*state.ForcedBatch, error) {
...
func (_m *StateMock) GetLastBatch(ctx *context.RequestContext, dbTx pgx.Tx) (*state.Batch, error) {
	ret := _m.Called(ctx, dbTx)

	var r0 *state.Batch
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) (*state.Batch, error)); ok {
		return rf(ctx, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) *state.Batch); ok {
		r0 = rf(ctx, dbTx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*state.Batch)
...
func (_m *StateMock) GetLastClosedBatch(ctx *context.RequestContext, dbTx pgx.Tx) (*state.Batch, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_m *StateMock) GetLastL2Block(ctx *context.RequestContext, dbTx pgx.Tx) (*types.Block, error) {
	ret := _m.Called(ctx, dbTx)

	var r0 *types.Block
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) (*types.Block, error)); ok {
		return rf(ctx, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) *types.Block); ok {
		r0 = rf(ctx, dbTx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *StateMock) GetLastL2BlockHeader(ctx *context.RequestContext, dbTx pgx.Tx) (*types.Header, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_m *StateMock) GetLastNBatches(ctx *context.RequestContext, numBatches uint, dbTx pgx.Tx) ([]*state.Batch, error) {
	ret := _m.Called(ctx, numBatches, dbTx)

	var r0 []*state.Batch
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint, pgx.Tx) ([]*state.Batch, error)); ok {
		return rf(ctx, numBatches, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint, pgx.Tx) []*state.Batch); ok {
	...
	if rf, ok := ret.Get(1).(func(*context.RequestContext, uint, pgx.Tx) error); ok {
...
func (_m *StateMock) GetLastStateRoot(ctx *context.RequestContext, dbTx pgx.Tx) (common.Hash, error) {
	ret := _m.Called(ctx, dbTx)

	var r0 common.Hash
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) (common.Hash, error)); ok {
		return rf(ctx, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, pgx.Tx) common.Hash); ok {
		r0 = rf(ctx, dbTx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *StateMock) GetLastTrustedForcedBatchNumber(ctx *context.RequestContext, dbTx pgx.Tx) (uint64, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_m *StateMock) GetLatestGer(ctx *context.RequestContext, maxBlockNumber uint64) (state.GlobalExitRoot, time.Time, error) {
...
func (_m *StateMock) GetLatestGlobalExitRoot(ctx *context.RequestContext, maxBlockNumber uint64, dbTx pgx.Tx) (state.GlobalExitRoot, time.Time, error) {
	ret := _m.Called(ctx, maxBlockNumber, dbTx)

	var r0 state.GlobalExitRoot
	var r1 time.Time
	var r2 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint64, pgx.Tx) (state.GlobalExitRoot, time.Time, error)); ok {
		return rf(ctx, maxBlockNumber, dbTx)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint64, pgx.Tx) state.GlobalExitRoot); ok {
		r0 = rf(ctx, maxBlockNumber, dbTx)
	} else {
		r0 = ret.Get(0).(state.GlobalExitRoot)
	}

	if rf, ok := ret.Get(1).(func(*context.RequestContext, uint64, pgx.Tx) time.Time); ok {
		r1 = rf(ctx, maxBlockNumber, dbTx)
	} else {
		r1 = ret.Get(1).(time.Time)
	}

	if rf, ok := ret.Get(2).(func(*context.RequestContext, uint64, pgx.Tx) error); ok {
...
func (_m *StateMock) GetLatestVirtualBatchTimestamp(ctx *context.RequestContext, dbTx pgx.Tx) (time.Time, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_m *StateMock) GetNonceByStateRoot(ctx *context.RequestContext, address common.Address, root common.Hash) (*big.Int, error) {
	ret := _m.Called(ctx, address, root)
...
func (_m *StateMock) GetTimeForLatestBatchVirtualization(ctx *context.RequestContext, dbTx pgx.Tx) (time.Time, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_m *StateMock) GetTransactionsByBatchNumber(ctx *context.RequestContext, batchNumber uint64, dbTx pgx.Tx) ([]types.Transaction, error) {
	ret := _m.Called(ctx, batchNumber, dbTx)
...
func (_m *StateMock) GetTxsOlderThanNL1Blocks(ctx *context.RequestContext, nL1Blocks uint64, dbTx pgx.Tx) ([]common.Hash, error) {
...
func (_m *StateMock) IsBatchClosed(ctx *context.RequestContext, batchNum uint64, dbTx pgx.Tx) (bool, error) {
...
func (_m *StateMock) ProcessBatch(ctx *context.RequestContext, request state.ProcessRequest, updateMerkleTree bool) (*state.ProcessBatchResponse, error) {
	ret := _m.Called(ctx, request, updateMerkleTree)

	var r0 *state.ProcessBatchResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, state.ProcessRequest, bool) (*state.ProcessBatchResponse, error)); ok {
		return rf(ctx, request, updateMerkleTree)
	}
	if rf, ok := ret.Get(0).(func(*context.RequestContext, state.ProcessRequest, bool) *state.ProcessBatchResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(*context.RequestContext, state.ProcessRequest, bool) error); ok {
...
func (_m *StateMock) StoreTransaction(ctx *context.RequestContext, batchNumber uint64, processedTx *state.ProcessTransactionResponse, coinbase common.Address, timestamp uint64, dbTx pgx.Tx) error {
...
func (_m *StateMock) UpdateBatchL2Data(ctx *context.RequestContext, batchNumber uint64, batchL2Data []byte, dbTx pgx.Tx) error {
	ret := _m.Called(ctx, batchNumber, batchL2Data, dbTx)

	var r0 error
	if rf, ok := ret.Get(0).(func(*context.RequestContext, uint64, []byte, pgx.Tx) error); ok {

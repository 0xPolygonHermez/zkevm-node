...
func (_m *StateMock) GetTransactionsByBatchNumber(ctx context.Context, batchNumber uint64, forkID uint64, dbTx pgx.Tx) ([]types.Transaction, []uint8, error) {
	ret := _m.Called(ctx, batchNumber, forkID, dbTx)

	var r0 []types.Transaction
	var r1 []uint8
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, pgx.Tx) ([]types.Transaction, []uint8, error)); ok {

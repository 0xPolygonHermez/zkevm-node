...
type StateInterface interface {
	...
	GetBalance(ctx context.Context, address common.Address, l2Block *types.Block) (*big.Int, error)
	GetCode(ctx context.Context, address common.Address, l2Block *types.Block) ([]byte, error)
	...
	GetStorageAt(ctx context.Context, address common.Address, position *big.Int, l2Block *types.Block) (*big.Int, error)

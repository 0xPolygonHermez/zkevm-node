...
type mockConstructorTestingTnewBatchProcessorMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func newBatchProcessorMock(t mockConstructorTestingTnewBatchProcessorMock) *batchProcessorMock {

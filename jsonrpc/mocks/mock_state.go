...
// GetTransactionsByBatchNumber provides a mock function with given fields: ctx, batchNumber, forkID, dbTx
func (_m *StateMock) GetTransactionsByBatchNumber(ctx context.Context, batchNumber uint64, forkID uint64, dbTx pgx.Tx) ([]coretypes.Transaction, []uint8, error) {
	ret := _m.Called(ctx, batchNumber, forkID, dbTx)

	var r0 []coretypes.Transaction
	var r1 []uint8
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, pgx.Tx) ([]coretypes.Transaction, []uint8, error)); ok {
		return rf(ctx, batchNumber, forkID, dbTx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, pgx.Tx) []coretypes.Transaction); ok {
		r0 = rf(ctx, batchNumber, forkID, dbTx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]coretypes.Transaction)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint64, uint64, pgx.Tx) []uint8); ok {
		r1 = rf(ctx, batchNumber, forkID, dbTx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]uint8)
		}
	...
	if rf, ok := ret.Get(2).(func(context.Context, uint64, uint64, pgx.Tx) error); ok {
		r2 = rf(ctx, batchNumber, forkID, dbTx)
	} else {
		r2 = ret.Error(2)
	}

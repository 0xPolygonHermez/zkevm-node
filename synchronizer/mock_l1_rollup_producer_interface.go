...
type mockConstructorTestingTnewL1RollupProducerInterfaceMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func newL1RollupProducerInterfaceMock(t mockConstructorTestingTnewL1RollupProducerInterfaceMock) *l1RollupProducerInterfaceMock {

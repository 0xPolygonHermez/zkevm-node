...
// L1EthermanInterfaceMock is an autogenerated mock type for the L1EthermanInterface type
type L1EthermanInterfaceMock struct {
	mock.Mock
}

// EthBlockByNumber provides a mock function with given fields: ctx, blockNumber
func (_m *L1EthermanInterfaceMock) EthBlockByNumber(ctx context.Context, blockNumber uint64) (*types.Block, error) {
...
func (_m *L1EthermanInterfaceMock) GetLatestBatchNumber() (uint64, error) {
	ret := _m.Called()
...
func (_m *L1EthermanInterfaceMock) GetLatestVerifiedBatchNum() (uint64, error) {
	ret := _m.Called()
...
func (_m *L1EthermanInterfaceMock) GetRollupInfoByBlockRange(ctx context.Context, fromBlock uint64, toBlock *uint64) ([]etherman.Block, map[common.Hash][]etherman.Order, error) {
...
func (_m *L1EthermanInterfaceMock) GetTrustedSequencerURL() (string, error) {
	ret := _m.Called()
...
func (_m *L1EthermanInterfaceMock) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
...
func (_m *L1EthermanInterfaceMock) VerifyGenBlockNumber(ctx context.Context, genBlockNumber uint64) (bool, error) {
...
// NewL1EthermanInterfaceMock creates a new instance of L1EthermanInterfaceMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewL1EthermanInterfaceMock(t interface {
	mock.TestingT
	Cleanup(func())
}) *L1EthermanInterfaceMock {
	mock := &L1EthermanInterfaceMock{}
	mock.Mock.Test(t)

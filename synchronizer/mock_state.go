...
// stateMock_GetCurrentL1InfoRoot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCurrentL1InfoRoot'
type stateMock_GetCurrentL1InfoRoot_Call struct {
	*mock.Call
}

// GetCurrentL1InfoRoot is a helper method to define mock.On call
func (_e *stateMock_Expecter) GetCurrentL1InfoRoot() *stateMock_GetCurrentL1InfoRoot_Call {
	return &stateMock_GetCurrentL1InfoRoot_Call{Call: _e.mock.On("GetCurrentL1InfoRoot")}
}

func (_c *stateMock_GetCurrentL1InfoRoot_Call) Run(run func()) *stateMock_GetCurrentL1InfoRoot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *stateMock_GetCurrentL1InfoRoot_Call) Return(_a0 common.Hash) *stateMock_GetCurrentL1InfoRoot_Call {
	_c.Call.Return(_a0)
	return _c
}

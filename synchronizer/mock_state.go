...
// GetReorgedTransactions provides a mock function with given fields: ctx, batchNumber, forkID, dbTx
func (_m *stateMock) GetReorgedTransactions(ctx context.Context, batchNumber uint64, forkID uint64, dbTx pgx.Tx) ([]*types.Transaction, error) {

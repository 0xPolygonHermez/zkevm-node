...
type mockConstructorTestingTnewL1RollupConsumerInterfaceMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func newL1RollupConsumerInterfaceMock(t mockConstructorTestingTnewL1RollupConsumerInterfaceMock) *l1RollupConsumerInterfaceMock {

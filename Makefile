...
generate-code-from-proto: ## Generates code from proto files
	...
	cd proto/src/proto/aggregator/v1 && protoc --proto_path=. --proto_path=../../../../include --go_out=../../../../../aggregator2/pb --go-grpc_out=../../../../../aggregator2/pb --go-grpc_opt=paths=source_relative --go_opt=paths=source_relative aggregator.proto

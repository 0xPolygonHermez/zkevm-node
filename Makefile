...
compile-scs: ## Compiles smart contracts used in tests and local deployments
	SC_NAME=counter SOLC_VERSION=0.8.13-alpine $(COMPILE_CMD) && $(GENERATE_CMD)
	SC_NAME=destruct SOLC_VERSION=0.8.13-alpine $(COMPILE_CMD) && $(GENERATE_CMD)
	SC_NAME=double SOLC_VERSION=0.8.13-alpine $(COMPILE_CMD) && $(GENERATE_CMD)
	SC_NAME=emitLog SOLC_VERSION=0.8.13-alpine $(COMPILE_CMD) && $(GENERATE_CMD)

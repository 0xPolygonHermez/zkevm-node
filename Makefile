...
DOCKERCOMPOSEUNISWAPUI := uniswap-ui
...
RUNUNISWAPUI := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEUNISWAPUI)
...
STOPUNISWAPUI := $(DOCKERCOMPOSE) stop $(DOCKERCOMPOSEUNISWAPUI) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEUNISWAPUI)

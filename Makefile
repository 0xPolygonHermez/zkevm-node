...
generate-mocks: ## Generates mocks for the tests, using mockery tool
	...
	mockery --name=BatchProcessorInterface --dir=jsonrpc --output=jsonrpc --outpkg=jsonrpc_test --structname=batchProcessorMock --filename=mock_batchProcessor_test.go

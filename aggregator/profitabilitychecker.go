...
func NewTxProfitabilityCheckerBase(state localState, interval time.Duration, minReward *big.Int) *TxProfitabilityCheckerBase {
...
func NewTxProfitabilityCheckerAcceptAll(state localState, interval time.Duration) *TxProfitabilityCheckerAcceptAll {
...
func isConsolidatedBatchAppeared(ctx context.Context, state localState, intervalAfterWhichBatchConsolidatedAnyway time.Duration) (bool, error) {

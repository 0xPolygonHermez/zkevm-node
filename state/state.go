...
func (s *State) ProcessSingleTransaction(
	ctx context.Context,
	batchNumber uint64,
	tx types.Transaction,
	isFirstTx bool,
	oldResponse *ProcessBatchResponse,
	dbTx pgx.Tx,
	caller CallerLabel,
) (*ProcessBatchResponse, error) {
	log.Debugf("*******************************************")
	...
	if isFirstTx {
		...
		oldStateRoot = s.previousBatch.StateRoot
	} else {
		oldStateRoot = oldResponse.NewStateRoot
	}

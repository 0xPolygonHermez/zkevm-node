...
type State interface {
	NewBatchProcessor(lastBachNumber uint64, withProofCalculation bool) BatchProcessor
...
func (s *BasicState) NewBatchProcessor(lastBachNumber uint64, withProofCalculation bool) BatchProcessor {

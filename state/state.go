...
type Storage interface {
	...
	AddTransactions(ctx context.Context, txs []*types.Transaction, batchNumber uint64) error
	AddReceipts(ctx context.Context, receipts []*Receipt, blockHash common.Hash) error

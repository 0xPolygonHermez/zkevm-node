...
func TestExecutorTransfer(t *testing.T) {
	...
	converted, err := testState.TestConvertToProcessBatchResponse(processBatchResponse, forkID)
	require.NoError(t, err)
...
func TestExecutorEstimateGas(t *testing.T) {
	...
	convertedResponse, err := testState.TestConvertToProcessBatchResponse(processBatchResponse, forkID)
	require.NoError(t, err)

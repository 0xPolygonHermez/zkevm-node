...
const vectorString = `[
    ...
    },
    {
        ...
        "data": "0x56d5be740000000000000000000000001275fbb540c8efc58b812ba83b0d0b8b9917ae98",
        "from": "0x4d5Cf5032B2a844602278b01199ED191A86c93ff",
        "l2TxHash": "0x380cb737b37d06e6d7e6a24ba2b1a3e29e18b28d367fc5a4fa57ddcf60a12a54"
    },
    {
        "nonce": "0x00",
        "gasPrice": "0x3b9aca00",
        ...
        "data": "",
        "from": "0x4d5Cf5032B2a844602278b01199ED191A86c93ff",
        "l2TxHash": "0x822ab53546a48dcbc25cdccc883e378b911554b9f00599a0d783e6376246732d"
    },
    {
        "nonce": "0x1",
        "gasPrice": "0x3b9aca00",
...
func TestL2TxHash(t *testing.T) {
	...
	for x, testVector := range testVectors {
		...
		if testVector.To != "" {
			aux := common.HexToAddress(testVector.To)
			to = &aux
		} else {
			to = nil
		}
		...
		if testVector.L2TxHash != "failed" {
			...
			tx := types.NewTx(&types.LegacyTx{Nonce: nonce,
				GasPrice: gasPrice,
				Gas:      gasLimit,
				To:       to,
				Value:    value,

...
func (m *Manager) setUpSequencer() error {
	...
	etherman, err := etherman.NewClient(ethermanConfig, auth, common.HexToAddress(poeAddress), common.HexToAddress(bridgeAddress), common.HexToAddress(maticTokenAddress))
	if err != nil {
		return err
	}
